...
<head>
    ...
    <title>Solution - suivre ton examen en live</title>
    <style>
    ...
    <div class="container"><a class="navbar-brand">Solution</a>
        ...
        <div id="my-nav" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="#ce">Centres d'examen</a></li>
                <li class="nav-item"><a class="nav-link" href="#news">News</a></li>
                <li class="nav-item"><a class="nav-link" href="#contact">Contact</a></li>
            </ul>
            <form class="form-inline my-2 my-lg-0">
                <a href="#" class="btn btn-outline-dark my-2 my-sm-0 mr-3 text-uppercase"  onclick="document.getElementById('modal-wrapper').style.display='block'">login</a> <!-- <a href="#" class="btn btn-info my-2 my-sm-0 text-uppercase">sign up</a> -->
            </form>
        </div>
    </div>
</nav>
<div class="container-fluid gtco-banner-area">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h1> Cette plateforme
                    gère le <span>Baccalaurea</span> comme
                    examen offiel au cameroun </h1>
                <p> Vous etes candidat, parent, centre d'examen, correcteur, surveillant ou meme potentiel visiteur; ce site vous est destiné. </p>
                <a href="#">Plus de detail <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
            <div class="col-md-6">
...
<div class="container-fluid gtco-feature" id="ce">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <div class="cover">
            ...
            <div class="col-md-5">
                <h2> Les centres d'examens,la reference des acivités examinatoires</h2>
                <p> Les centre d'examens sont les zones d'activités et interface de l'OBC pour les usagers. </p>
                <p>
                    <small> C'est dans ces centres d'examen que s'effectuent les examens et les corrections et meme la publication des resultats.ces ces centre son dotés d'une organisaion remarquable.
                    </small>
                </p>
                <a href="#">Liste des centres <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
        </div>
    </div>
</div>
<div class="container-fluid gtco-features" id="services">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <h2> Les services offert<br/>
                    par <span style="color: -moz-linear-gradient(left, #1d3ede, #01e6f8);">Solution</span> pour repondre
                    à vos besoins </h2>
                <p> Nunc sodales lobortis arcu, sit amet venenatis erat placerat a. Donec lacinia magna nulla, cursus
                    ...
                    neque. </p>
                <a href="#">Tous les services <i class="fa fa-angle-right" aria-hidden="true"></i></a></div>
            <div class="col-lg-8">
                <svg id="bg-services"
                     width="100%"
                ...
                <div class="row">
                    <div class="col">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <h3 class="card-title">Actialitées</h3>
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <h3 class="card-title">Barbillard</h3>
                                <p class="card-text">Liste des candidats, des surveillants, des correcteurs et des centres d'examen</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
...
<!-- login -->
<div id="modal-wrapper" class="modal login_form">
    <form class="modal-content animate" action="#">
        <div class="imgcontainer">
            <span onclick="document.getElementById('modal-wrapper').style.display='none'" class="close" title="Clode login">&times;</span>
            <img src="images/login.png" alt="avatar" class="avatar">
            <h1 style="text-align: center;">Examination center</h1>
        </div>
        ...
        <div class="container box">
            ...
            <div class="inputbox">
                <input type="text" required="" name="secret_code" min="8">
                <label for="secret_code">Secret code</label>
            </div>
            <button type="submit" style="background: -moz-linear-gradient(left, #1d3ede, #01e6f8);">Login</button>
            <input type="checkbox" style="margin: 26px 30px;" name="">Remember me
